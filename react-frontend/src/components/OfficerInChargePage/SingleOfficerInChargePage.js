...
const SingleOfficerInChargePage = (props) => {
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">officer_name</label><p className="m-0 ml-3" >{_entity?.officerName}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">telephone_number</label><p className="m-0 ml-3" >{_entity?.telephoneNumber}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">IC_Number</label><p className="m-0 ml-3" >{_entity?.icNumber}</p></div>
