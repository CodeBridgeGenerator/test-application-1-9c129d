...
const OfficerInChargeCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        if(!validate()) return;
        let _data = {
            officerName: _entity?.officerName,designation: _entity?.designation,telephoneNumber: _entity?.telephoneNumber,icNumber: _entity?.icNumber,email: _entity?.email,organizationName: _entity?.organizationName,
    ...
    return (
        <Dialog header="Create Officer In Charge" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            ...
            <span className="align-items-center">
                <label htmlFor="officerName">officer_name:</label>
...
<div className="col-12 md:col-6 field mt-5">
            <span className="align-items-center">
                <label htmlFor="telephoneNumber">telephone_number:</label>
...
<div className="col-12 md:col-6 field mt-5">
            <span className="align-items-center">
                <label htmlFor="icNumber">IC_Number:</label>
