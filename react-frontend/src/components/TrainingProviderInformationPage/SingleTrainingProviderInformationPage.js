...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">organization_address</label><p className="m-0 ml-3" >{_entity?.organizationAddress}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">organization_contact_no</label><p className="m-0 ml-3" >{Number(_entity?.organizationContactNo)}</p></div>
