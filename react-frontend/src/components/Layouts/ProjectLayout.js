...
import TrainingProgramOwnershioPage from "../TrainingProgramOwnershioPage/TrainingProgramOwnershioPage";
...
const ProjectLayout = (props) => {
  ...
  const renderChild = (page) => {
    switch (page) {
      ...
      case "dash":
        return <Dashboard />;
case "trainingProgramOwnershio":
                return <TrainingProgramOwnershioPage />;
...
<li
                onClick={() => {
                  setCurrentActiveTab2("trainingProgramOwnershio");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "trainingProgramOwnershio",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "trainingProgramOwnershio" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "trainingProgramOwnershio",
                      "text-black": props?.currentActiveTab2 !== "trainingProgramOwnershio",
                    })}
                  >
                  Training Program Ownershio
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "trainingProgramOwnershio",
                      "text-yellow-700": props?.currentActiveTab2 !== "trainingProgramOwnershio",
                    })}
                  >
